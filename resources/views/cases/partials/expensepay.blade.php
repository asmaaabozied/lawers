<table id="expensepayment" class="table table-hover non-hover" style="width:100%">
    <thead>
    <tr>
        <th></th>
        <th>رقم القضية</th>
    ...
    <tbody>
    @foreach($lawyerCase->expensepayment as $item)
        <tr>
...
@push('javascript')
    <x-datatables id="expensepayment"></x-datatables>
@endpush
