        ...
        <div class="widget-content widget-content-area br-6">
            <div class="row">
                <div class="col">
                    ...
                    <x-show-text title="مدفوعات المصاريف" :value="$lawyerCase->expensepayment->sum('value') ?? ''"></x-show-text>
                ...
                <div class="col">
                    ...
                    <x-show-text title="اجمالي المصاريف" :value="$lawyerCase->expensess->sum('value') ?? ''"></x-show-text>
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area border-top-tab br-4">
            <ul class="nav nav-tabs mb-3 mt-3" id="borderTop" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="border-top-home-tabb" data-toggle="tab" href="#border-top-homee"
                       role="tab" aria-controls="border-top-home" aria-selected="true"><i data-feather="home"></i>المصروفات</a>
                </li>


                <li class="nav-item">
                    <a class="nav-link" id="border-top-home-tabbb" data-toggle="tab" href="#border-top-homee"
                       role="tab" aria-controls="border-top-home" aria-selected="true"><i data-feather="home"></i>مدفوعات المصاريف</a>
                </li>
            ...
            <div class="tab-content" id="borderTopContent">
                ...
                <div class="tab-pane fade show show" id="border-top-homee" role="tabpanel"
                     aria-labelledby="border-top-home-tabb">
                    @include('cases.partials.expense')
                </div>


                    <div class="tab-pane fade show show show" id="border-top-homeee" role="tabpanel"
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area border-top-tab br-4">
            ...
            <div class="tab-content" id="borderBottomContent">
                @foreach(\App\Model\Typecourt::get()->pluck('name','id') as $key=>$value)
                    <div class="tab-pane fade @if($key === 1) active show @endif" id="typecourt_tab_{{$key}}" role="tabpanel" aria-labelledby="typecourt_{{$key}}">
