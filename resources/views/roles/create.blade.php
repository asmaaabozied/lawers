...
@section('content')
    ...
    @csrf
            ...
            <x-input-text name="display_name" value="{{old('display_name')}}" title="الاسم المعروض"></x-input-text>
            <x-input-text name="description" value="{{old('description')}}" title="الوصف"></x-input-text>
