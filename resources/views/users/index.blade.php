...
@section('content')
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-header d-flex justify-content-between mb-3">
            ...
            <a href="{{route('users.create')}}" class="btn btn-outline-primary" title="اضافة جديد"><i data-feather="plus"></i></a>
            @else
                    ...
                    @foreach($users as $item)
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <a href="{{route('users.show', $item)}}" class="text-primary mr-3"><i data-feather="eye"></i></a>
                                @else
                                ...
                                @endif
                                    ...
                                    <a href="{{route('users.edit', $item)}}" class="text-success mr-3"><i data-feather="edit"></i></a>
                                    @else
